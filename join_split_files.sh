...
cat bootimg/04_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null >> bootimg/04_dtbdump_	qcom,rtic-id.dtb
rm -f bootimg/04_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null
cat bootimg/04_dtbdump_B.* 2>/dev/null >> bootimg/04_dtbdump_B
rm -f bootimg/04_dtbdump_B.* 2>/dev/null
cat z'z_.dtb.* 2>/dev/null >> z'z_.dtb
rm -f z'z_.dtb.* 2>/dev/null
