...
cat bootimg/04_dtbdump_UN)_\.dtb.* 2>/dev/null >> bootimg/04_dtbdump_UN)_\.dtb
rm -f bootimg/04_dtbdump_UN)_\.dtb.* 2>/dev/null
...
cat .git/objects/pack/pack-9c5e0638c1ce453c635c42ba0536ed0c0ae93fce.pack.* 2>/dev/null >> .git/objects/pack/pack-9c5e0638c1ce453c635c42ba0536ed0c0ae93fce.pack
rm -f .git/objects/pack/pack-9c5e0638c1ce453c635c42ba0536ed0c0ae93fce.pack.* 2>/dev/null
